...
public class CustomCameraView2 extends SurfaceView implements SurfaceHolder.Callback, Runnable {
...
//        mCamera = Camera.open();
//        Camera.Parameters parameters = mCamera.getParameters();//获取默认配置
//        mCamera.setDisplayOrientation(0);//预览方向
//        try {
//            mCamera.setPreviewDisplay(mHolder);//设置预览
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
    }
